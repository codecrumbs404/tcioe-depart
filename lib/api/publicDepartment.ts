...
import { API_PUBLIC_PREFIX } from '@/lib/env'
...
export function listDepartmentDownloads(slug: string, params?: { limit?: number; offset?: number }) {
  return apiGet<Paginated<DepartmentDownload>>(`${P}/departments/${slug}/downloads`, params)
}
...
export function listDepartmentEvents(
  ...
  return apiGet<Paginated<DepartmentEvent>>(`${P}/departments/${slug}/events`, params)
}

export function listDepartmentPlans(slug: string, params?: { limit?: number; offset?: number }) {
  return apiGet<Paginated<DepartmentPlan>>(`${P}/departments/${slug}/plans`, params)
}
...
export function listDepartmentPrograms(
  ...
  return apiGet<Paginated<DepartmentProgram>>(`${P}/departments/${slug}/programs`, params)
}
...
export function listDepartmentStaffs(
  ...
  return apiGet<Paginated<DepartmentStaff>>(`${P}/departments/${slug}/staffs`, params)
}

export function listEventGallery(eventId: number, params?: { limit?: number; offset?: number }) {
  return apiGet<Paginated<EventGalleryItem>>(`${P}/departments/events/${eventId}/gallery`, params)
}
